/**
 * MetadataPage - Full-page metadata management
 * Uses MetadataManager functionality without modal wrapper
 */
    ...
    <div className="page metadata-page">
      <div className="page-header">
        ...
        <div className="page-header-actions">
          ...
          <button className="btn btn-sm" onClick={() => setRefreshKey(k => k + 1)} title="Refresh list">
            Refresh
          </button>
        </div>
      </div>

      <div className="page-content metadata-manager-body">
        {/* Status Bar */}
              ...
              <div key={backup.name} className="metadata-card">
                ...
                <div className="card-actions">
                  ...
                  <button
                    ...
                    onClick={() => setEditingBackup(backup.name)}
                    title="Edit metadata"
                  >
                    Edit
                  </button>
        ...
        {/* Footer Stats */}
        <div className="metadata-footer-stats">
          <small>
